...
@section('pageContent')
    <form action="{{ route('artikel.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row w-100 g-4 h-100">
            <p class="font-bold text-2xl text-gray-800">Tambah Artikel</p>
            {{-- Kolom Kiri - Upload Thumbnail --}}
            <div class="col-md-4">
                <div class="card border shadow">
                    <div class="card-body">
                        <div class="mb-4">
                            <label class="font-bold text-xl text-gray-800">Thumbnail <span class="text-red-500">*</span></label>
                            <div class="relative mt-2 w-full aspect-[16/9] rounded-xl border-2 border-dashed border-gray-300 flex items-center justify-center bg-gray-50 hover:bg-gray-100 group overflow-hidden">
                            ...
                            <p class="text-sm text-gray-500 mt-2">Format diperbolehkan: <strong>.png</strong>, <strong>.jpg</strong>, <strong>.jpeg</strong>.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-8">
                <div class="card border shadow max-h-max">
                    <div class="card-body">
                        <label class="font-bold text-xl text-gray-800">Form Artikel</label>

                        {{-- Judul --}}
                        <div class="flex flex-col mt-3">
                            <label class="font-medium text-gray-700">Judul Artikel <span class="text-red-500">*</span></label>
                        ...
                        <div class="flex flex-col mt-3">
                            ...
                            <textarea name="abstrak" rows="4"
                                ...
                                placeholder="Masukan abstrak    "></textarea>
                        </div>
                        {{-- Penulis --}}
                        <div class="flex flex-col mt-3">
                        ...
                        {{-- Tanggal Upload --}}
                        <div class="flex flex-col mt-3">
                            <label class="font-medium text-gray-700">Tanggal Upload <span class="text-red-500">*</span></label>
                        ...
                        <div class="flex flex-col mt-3">
                            ...
                            <select name="kategori" required
                                class="mt-1 border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline placeholder-gray-400 text-sm">
