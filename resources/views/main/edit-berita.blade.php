                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <div
                                ...
                                <img id="previewImage"
                                    src="{{ $berita->thumbnail ? asset('thumbnails/' . $berita->thumbnail) : 'https://cdn-icons-png.flaticon.com/512/149/149852.png' }}"
                                    alt="Preview"
                ...
                <div class="card border shadow max-h-max">
                    <div class="card-body">
                        ...
                        <div class="flex flex-col mt-3">
                            ...
                            <input name="judul" type="text" value="{{ old('judul', $berita->judul) }}"
                        ...
                        <div class="flex flex-col mt-3">
                            ...
                            <textarea name="abstrak" rows="4"
                                ...
                                placeholder="Masukkan abstrak">{{ old('abstrak', $berita->abstrak) }}</textarea>
                        </div>

                        {{-- Penulis --}}
                        <div class="flex flex-col mt-3">
                            <label class="font-medium text-gray-700">Penulis <span class="text-red-500">*</span></label>
                            <input name="penulis" type="text" value="{{ old('penulis', $berita->penulis) }}"
                                class="mt-1 border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline placeholder-gray-400 placeholder:text-sm"
                        ...
                        <div class="flex flex-col mt-3">
                            ...
                            <input name="tanggal_upload" type="date"
                                value="{{ old('tanggal_upload', \Carbon\Carbon::parse($berita->tanggal_upload)->format('Y-m-d')) }}"
