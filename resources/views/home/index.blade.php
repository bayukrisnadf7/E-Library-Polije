    ...
    <div class="max-w-screen">
        ...
        <div class="bg-[#F8F5FC] md:min-h-screen max-h-[710px]">
            <div class="flex md:justify-between flex-col md:flex-row items-center">
                <div
                    class="text-[#2A1D43] flex flex-col md:gap-8 gap-4 w-full md:p-10 mx-10 p-5 opacity-0 translate-x-[-50px] transition-all duration-1000 animate-on-scroll">
            ...
            <div class="relative -bottom-[35px] w-full flex justify-center">
                <div class="w-full md:h-[120px] h-full rounded-xl md:mx-[80px] mx-5 flex md:flex-row flex-col overflow-hidden">
                    <!-- Bagian pertama -->
            ...
            <div class="relative md:bottom-[65px] bottom-[150px] flex md:flex-row flex-col justify-between items-center md:w-[1200px] md:mx-40 md:gap-0 gap-[20px] text-white">
            ...
            <div class="mt-10">
                <div class="swiper mySwiper w-full">
                    <div class="swiper-wrapper w-full">
                        ...
                        <div class="swiper-slide flex justify-center">
                            <button>
                                <div class="flex flex-col items-center gap-2 group text-center w-[250px]">
                                    <img src="img/skbp.png" alt="">
                                    <div class="flex flex-col justify-center items-center gap-1 text-center font-bold">
                                        <p>Surat Keterangan Bebas Keterangan ( SKBP )</p>
        ...
        <div class="w-full md:mt-16 mt-10 min-h-screen">
            ...
            <div class="flex justify-between md:mt-10 mt-10 text-[#2A1D43] md:text-xl text-sm">
                <p class=" font-bold mx-20">Artikel</p>
                <div class="flex items-center gap-2 cursor-pointer mx-20">
            ...
            <div
                class="grid grid-cols-1 md:grid-cols-4 mx-10 place-items-center  mt-10 opacity-0 translate-y-5 transition-all duration-1000 animate-on-scroll-2">
                <div class="flex flex-col gap-5 md:max-w-[300px] rounded-2xl bg-[#F8F5FC]">
        ...
        {{-- Section 5 Start --}}
        <div class="min-h-screen w-full bg-[#F8F5FC] py-10">
            <div class="flex justify-between md:mx-20 mx-5 text-[#2A1D43] md:text-xl text-sm">
            ...
            <div
                class="grid grid-cols-1 md:grid-cols-2 gap-10 py-10 md:mx-20 mx-5 opacity-0 translate-y-5 transition-all duration-1000 animate-on-scroll-2">

                <div class="flex md:flex-row flex-col md:h-[250px] h-[250px] gap-2 rounded-2xl bg-white">
                    <img src="img/berita.png" alt="Gambar Berita"
                        class="md:w-[300px] object-cover rounded-xl">
