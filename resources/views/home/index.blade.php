    ...
    <div class="max-w-screen">
        ...
        <div class="md:mt-20 mt-10 mb-10 md:mx-20 mx-5">
            ...
            <div class="relative mt-10">
                <input type="text"
                    class="w-full md:p-5 p-3 rounded-full border-2 border-[#5B9BC1] mt-1 placeholder:text-gray-400 placeholder:font-bold"
                    placeholder="Cari buku...">
                <img src="img/Vector (6).png" alt="" class="absolute md:right-8 right-4 md:bottom-5 bottom-2.5">
            </div>
        ...
        <div class="w-full md:mt-16 mt-10 opacity-0 translate-y-5 transition-all duration-1000 animate-on-scroll-2">
                ...
                <div class="flex flex-col gap-5 md:max-w-[350px] rounded-2xl bg-[#F8F5FC]">
                    ...
                    <div class="flex flex-col gap-2 md:p-5 p-2">
                        <p class="font-bold">Mengoptimalkan Fasilitas Perpustakaan Kampus untuk Mendukung Prestasi
                            Mahasiswa</p>
                        <p>21/02/2025</p>
                        <p class="md:line-clamp-6 line-clamp-5 md:text-base text-sm">Perpustakaan kampus memiliki peran penting dalam mendukung
            ...
            <div class="flex justify-between md:mx-40 mx-5 mt-20 text-[#2A1D43] md:text-xl text-sm">
                <p class="font-bold">Artikel</p>
                <div class="flex items-center gap-2 cursor-pointer">
                    <p class="font-semibold">Selengkapnya</p>
                    <img src="img/Vector (5).png" alt="" class="bg-black p-1 rounded-full">
