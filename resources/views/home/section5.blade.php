...
<div class="md:min-h-[600px] min-h-[1250px] w-full bg-[#F8F5FC] md:py-5">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 lg:mx-20 gap-14 place-items-center py-10 space-y-16 md:space-y-0 opacity-0 translate-y-5 transition-all duration-1000 animate-on-scroll-2">
        <div class="relative md:w-[400px] w-[350px] md:h-[270px] h-[250px] overflow-visible">
            ...
            <div class="absolute bg-white flex items-center md:bottom-[-80px] bottom-[-70px] right-0 md:w-[370px] w-[320px] shadow-lg">
                <div class="flex flex-col gap-2 md:p-5 p-2">
                    <div class="flex gap-5 items-center">
                        <p class="text-black font-semibold md:text-base text-sm">Topik: </p>
                        <p class="bg-[#3694A8] text-white px-1 py-1 rounded-lg md:text-sm text-xs">Buku</p>
                    </div>
                    ...
                    <p class="font-semibold md:text-base text-sm">Mengoptimalkan Fasilitas Perpustakaan Kampus untuk Mendukung Prestasi
                        Mahasiswa</p>
                </div>
            </div>
        </div>
